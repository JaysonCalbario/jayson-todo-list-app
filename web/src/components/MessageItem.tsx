'use client';
import { MessageItemProps } from '../app/lib/types';

const MessageItem = ({ msg, clientId, index }: MessageItemProps) => {
          ...
          <div className="w-8 h-8 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center text-sm font-bold shadow">
            ...
            >
              <path
                ...
                d="M5.121 17.804A11.954 11.954 0 0012 20c2.386 0 4.597-.703 6.46-1.903A7.978 7.978 0 0016 13H8a7.978 7.978 0 00-2.879 4.804zM12 12a5 5 0 100-10 5 5 0 000 10z"
              />
            </svg>
          </div>
        </div>
